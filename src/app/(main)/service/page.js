...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d131d] text-slate-200">
      ...
      {/* ==================== HERO SECTION ==================== */}
      {/* ปรับ pt-28 md:pt-36 หลบ Navbar และเปลี่ยนสีพื้นหลัง */}
      <section className="relative px-4 sm:px-6 lg:px-8 pt-28 md:pt-36 pb-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          
          {/* ข้อความฝั่งซ้าย */}
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-xs sm:text-sm font-medium text-indigo-400">
              บริการของเรา
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link
                href="/"
                className="px-7 py-3.5 bg-white text-slate-950 hover:bg-slate-100 font-bold rounded-xl shadow-lg transition-all transform active:scale-95"
              >
                เลือกซื้อสินค้า
              </Link>
              <Link
                href="/contact"
                className="px-7 py-3.5 bg-slate-800/80 border border-slate-700 hover:bg-slate-700 text-white font-bold rounded-xl transition-all"
              >
                ติดต่อเรา
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden border border-[#1e293b] shadow-2xl bg-[#121926] p-2">
              {/* ใช้รูปแบนเนอร์จำลองที่ตกแต่งสไตล์ป้ายหน้าร้าน */}
              <div className="relative rounded-xl overflow-hidden aspect-[4/3] bg-slate-950 flex flex-col justify-between p-6 border border-[#1e293b]">
                ...
                <div className="relative z-20 text-center space-y-2 my-auto">
                  ...
                  <div className="inline-block px-4 py-1 bg-indigo-500/20 rounded-full text-xs font-semibold tracking-wider text-indigo-300 border border-indigo-500/30">
                    ปลอดภัย มั่นใจ 100%
                  </div>
                </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {servicesList.map((service) => (
            <div
              key={service.id}
              className="bg-[#121926] border border-[#1e293b] hover:border-indigo-500/40 rounded-2xl p-6 shadow-xl transition-all duration-300 flex flex-col justify-between group"
            >
              <div>
